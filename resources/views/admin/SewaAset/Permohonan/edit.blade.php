                                        ...
                                        <div class="row gy-3">
                                            <div class="col-xl-6">
                                                ...
                                                <select class="jenis-permohonan form-control" name="jenisPermohonan"
                                                    ...
                                                    @foreach ($jenisPermohonan as $jP)
                                                        <option value="{{ $jP->idJenisPermohonan }}" {{ $jP->idJenisPermohonan === $permohonanSewa->idJenisPermohonan ? 'selected' : '' }}>
                                                            {{ $jP->jenisPermohonan }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-xl-6">
                                                <label for="nomor-permohonan" class="form-label">Nomor
                                                    Permohonan</label>
                                                <input type="text" class="form-control" id="nomorPermohonan" value="{{ $permohonanSewa->nomorSuratPermohonan }}"
                                            ...
                                            <div class="col-xl-2">
                                                ...
                                                <input type="text" class="form-control" id="lama-sewa" name="lamaSewa" value="{{ $permohonanSewa->lamaSewa }}"
                    ...
                    <div class="d-flex gap-3">
                        <div class="flex-fill">
                            <h6 class="mb-1 fs-13">Nama Dokumen Kelengkapan</h6>
                                <select class="jenis-dokumen form-control" name="jenisDokumen[]" required id="jenis-dokumen">
                                    <option></option>
