            ...
            <div class="card custom-card">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="validationCustom01" placeholder="Masukkan Jenis Status" value="Mark Van Bommel" required>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="validationTextarea" placeholder="Masukkan Keterangan" rows="4">Keterangan Jenis Status</textarea>
                    </div>
