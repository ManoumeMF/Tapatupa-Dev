                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="validationCustom01"
                                placeholder="Masukkan Parent Bidang" name="parentBidang" min="1" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="validationTextarea" name="keterangan" placeholder="Masukkan Keterangan"
                                rows="4"></textarea>
                        </div>
                    </div>
