...
Route::delete("/jperuntukan-sewa/hapus", [PeruntukanSewaController::class, 'delete'])->name('PeruntukanSewa.delete');
Route::get("/jperuntukan-sewa/detail", [PeruntukanSewaController::class, 'detail'])->name('PeruntukanSewa.detail');
...
Route::get("/jjenis-dokumen/detail", [JenisDokumenController::class, 'detail'])->name('JenisDokumen.detail');